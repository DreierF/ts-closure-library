 ...
 */
function isAvailable(currencyCode) {
 ...
 */
function getGlobalCurrencyPattern(currencyCode) {
 ...
 */
function getGlobalCurrencySign(currencyCode) {
  const info = CurrencyInfo[currencyCode];
 ...
 * @return {string} Global currency sign for given currency.
 */
function getGlobalCurrencySignWithFallback(currencyCode) {
 ...
 */
function getLocalCurrencyPattern(currencyCode) {
  const info = CurrencyInfo[currencyCode];
 ...
 * @return {string} Local currency sign for given currency.
 */
function getLocalCurrencySignWithFallback(currencyCode) {
 ...
 */
function getPortableCurrencyPattern(currencyCode) {
  const info = CurrencyInfo[currencyCode];
 ...
 */
function getPortableCurrencySign(currencyCode) {
 ...
 * @return {string} Portable currency sign for given currency.
 */
function getPortableCurrencySignWithFallback(
    currencyCode) {
  if (currencyCode in CurrencyInfo) {
    return CurrencyInfo[currencyCode][2];
  } else {
 ...
 */
function isPrefixSignPosition(currencyCode) {
 ...
 */
function adjustPrecision(pattern, currencyCode) {
  const strParts = ['0'];
  const info = CurrencyInfo[currencyCode];
  if (!info) {
...
export {CurrencyInfo, CurrencyInfoTier2, addTier2Support, adjustPrecision, getGlobalCurrencyPattern, getGlobalCurrencySign, getGlobalCurrencySignWithFallback, getLocalCurrencyPattern, getLocalCurrencySign, getLocalCurrencySignWithFallback, getPortableCurrencyPattern, getPortableCurrencySign, getPortableCurrencySignWithFallback, isAvailable, isPrefixSignPosition, isValid};