...
class NumberFormat {
   ...
   */
  roundNumber_(number) {
    var shift = NumberFormat.decimalShift_;
  ...
  subformatExponential_(
    ...
    var exponent = math.safeFloor(Math.log(number) / Math.log(10));
  ...
  getUnitFor_(base, plurality) {
    var table = this.compactStyle_ == NumberFormat.CompactStyle.SHORT ?
