...
class DateTimeParse {
   ...
   * @private
   */
  isNumericField_(ch, count) {
    if (count <= 0) {
      return false;
    }
    var i = DateTimeParse.NUMERIC_FORMAT_CHARS_.indexOf(ch);
   ...
   * @private
   */
  assertPatternSupportsPredictive_() {
    for (var i = 0; i < this.patternParts_.length; i++) {
 ...
 * @private
 */
DateTimeParse.PREDICTIVE_FORMAT_CHARS_ = 'ahHkKm';
