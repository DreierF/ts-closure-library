...
export {ANDROID, ASSUME_ANDROID, ASSUME_ANY_VERSION, ASSUME_EDGE, ASSUME_GECKO, ASSUME_IE, ASSUME_IPAD, ASSUME_IPHONE, ASSUME_IPOD, ASSUME_KAIOS, ASSUME_LINUX, ASSUME_MAC, ASSUME_MOBILE_WEBKIT, ASSUME_OPERA, ASSUME_WEBKIT, ASSUME_WINDOWS, ASSUME_X11, DOCUMENT_MODE, EDGE, EDGE_OR_IE, GECKO, IE, IOS, IPAD, IPHONE, IPOD, KAIOS, LINUX, MAC, MOBILE, OPERA, PLATFORM, SAFARI, VERSION, WEBKIT, WINDOWS, X11, compare, getNavigator, getNavigatorTyped, getUserAgentString, isDocumentMode, isDocumentModeOrHigher, isVersion, isVersionOrHigher};