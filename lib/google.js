 ...
 * use Trusted Types.
 */
const TRUSTED_TYPES_POLICY_NAME = 'goog';
...
export {DEBUG, DISALLOW_TEST_ONLY_CODE, ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING, FEATURESET_YEAR, LOCALE, SEAL_CLASS_INSTANCES, TRUSTED_SITE, TRUSTED_TYPES_POLICY_NAME, bind, cloneObject, createTrustedTypesPolicy, defineClass, exportProperty, exportSymbol, forwardDeclare, getCssName, getMsg, getMsgWithFallback, getObjectByName, getScriptNonce, getUid, globalEval, hasUid, inherits, isArrayLike, isDateLike, isFunction, isObject, mixin, now, nullFunction, partial, removeUid, setCssNameMapping, setTestOnly, typeOf};