...
export {DEBUG, DISALLOW_TEST_ONLY_CODE, ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING, FEATURESET_YEAR, LOCALE, SEAL_CLASS_INSTANCES, STRICT_MODE_COMPATIBLE, TRUSTED_SITE, TRUSTED_TYPES_POLICY_NAME, bind, cloneObject, createTrustedTypesPolicy, defineClass, exportProperty, exportSymbol, forwardDeclare, getCssName, getHashCode, getMsg, getMsgWithFallback, getObjectByName, getScriptNonce, getUid, globalEval, hasUid, inherits, isArray, isArrayLike, isDateLike, isFunction, isObject, mixin, now, nullFunction, partial, removeHashCode, removeUid, setCssNameMapping, setTestOnly, tagUnsealableClass, typeOf};