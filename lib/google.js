 ...
 * @type {boolean|undefined}
 */
GetMsgOptions.prototype.unescapeHtmlEntities;
 ...
 * @type {!Object<string, string>|undefined}
 */
GetMsgOptions.prototype.original_code;
 ...
 * @type {!Object<string, string>|undefined}
 */
GetMsgOptions.prototype.example;
...
export {DEBUG, DISALLOW_TEST_ONLY_CODE, ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING, FEATURESET_YEAR, GetMsgOptions, LOCALE, SEAL_CLASS_INSTANCES, TRUSTED_SITE, TRUSTED_TYPES_POLICY_NAME, bind, cloneObject, createTrustedTypesPolicy, defineClass, exportProperty, exportSymbol, forwardDeclare, getCssName, getLocale, getMsg, getMsgWithFallback, getObjectByName, getUid, globalEval, hasUid, inherits, isArrayLike, isDateLike, isObject, now, nullFunction, partial, removeUid, setCssNameMapping, setTestOnly, typeOf};