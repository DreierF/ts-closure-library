...
import {EventLike as EventsEventLike} from './eventlike.js';
...
export {CAPTURE_SIMULATION_MODE, CaptureSimulationMode, ENABLE_MONITORING, EventHandler, EventWrapper, Key, Listenable, ListenableType, Listener, ListenerMap, dispatchEvent, events_EventTarget as EventTarget, expose, fireListener, fireListeners, getListener, getListeners, getProxy, getTotalListenerCount, getUniqueId, hasListener, listen, listenOnce, listenWithWrapper, protectBrowserEventEntryPoint, removeAll, unlisten, unlistenByKey, unlistenWithWrapper, wrapListener};