...
function getHTMLElement(id) {
  ...
  return asserts.assertInstanceof(element, HTMLElement);
};
 ...
 */
function getRequiredHTMLElement(id) {
  'use strict'
  return asserts.assertInstanceof(
      getRequiredElementHelper_(document, id), HTMLElement);
};
...
function getRequiredElementHelper_(doc, id) {
  ...
  element =
      asserts.assertElement(element, 'No element found with id: ' + id);
  return element;
};
 ...
 */
function getHTMLElementByClass(className, opt_parent) {
  'use strict'
 ...
 * @return {!HTMLElement} The first item with the class name provided.
 */
function getRequiredHTMLElementByClass(className, opt_parent) {
  'use strict'
 ...
 */
function copyContents(target, source) {
  asserts.assert(
...
class DomHelper {
  ...
  copyContents(target, source) {
    return copyContents(target, source);
  }
...
export {$, $$, $dom, ASSUME_QUIRKS_MODE, ASSUME_STANDARDS_MODE, Appendable, DomHelper, append, appendChild, canHaveChildren, compareNodeOrder, constHtmlToNode, contains, copyContents, createDom, createElement, createTable, createTextNode, findCommonAncestor, findElement, findElements, findNode, findNodes, flattenElement, getActiveElement, getAncestor, getAncestorByClass, getAncestorByTagNameAndClass, getCanvasContext2D, getChildren, getDocument, getDocumentHeight, getDocumentHeightForWindow, getDocumentScroll, getDocumentScrollElement, getDomHelper, getElement, getElementByClass, getElementByTagNameAndClass, getElementsByClass, getElementsByTagName, getElementsByTagNameAndClass, getFirstElementChild, getFrameContentDocument, getFrameContentWindow, getHTMLElement, getHTMLElementByClass, getLastElementChild, getNextElementSibling, getNextNode, getNodeAtOffset, getNodeTextLength, getNodeTextOffset, getOuterHtml, getOwnerDocument, getPageScroll, getParentElement, getPixelRatio, getPreviousElementSibling, getPreviousNode, getRawTextContent, getRequiredElement, getRequiredElementByClass, getRequiredHTMLElement, getRequiredHTMLElementByClass, getTextContent, getViewportSize, getWindow, insertChildAt, insertSiblingAfter, insertSiblingBefore, isCss1CompatMode, isElement, isFocusable, isFocusableTabIndex, isInDocument, isNodeLike, isNodeList, isWindow, removeChildren, removeNode, replaceNode, safeHtmlToNode, setFocusableTabIndex, setProperties, setTextContent};