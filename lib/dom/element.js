...
const isHtmlElement = (value) => {
  return google.isObject(value) && isElement(value) &&
...
const isHtmlElementOfType = (value, tagName) => {
  return google.isObject(value) && isHtmlElement(value) &&
