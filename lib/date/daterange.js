...
class DateRange {
   ...
   */
  iterator() {
    return new DateRange_Iterator(this);
  };
 ...
 * @final
 */
class DateRange_Iterator extends IterIterator {
  ...
  /**
   * @return {!IIterableResult<!DateDate>}
   * @override
   */
  next() {
    ...
    return goog_iter.createEs6IteratorYield(rv);
  };
  ...
  nextValueOrThrow() {
    return goog_iter.toEs4IteratorNext(
        DateRange_Iterator.prototype.next.call(this));
  };
}

export {DateRange, DateRange_Iterator as Iterator, StandardDateRangeKeys};