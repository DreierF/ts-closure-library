 ...
 */
declare class goog_Promise<TYPE, RESOLVER_CONTEXT> implements Goog_Thenable<TYPE> {
    /**
     ...
     *     given reason.
     */
    static reject(opt_reason?: any | undefined): goog_Promise<any, any>;
    /**
     ...
     * @template TYPE
     */
    static allSettled<TYPE>(promises: any[]): goog_Promise<{
        fulfilled: boolean;
        value: TYPE | undefined;
     ...
     * @template TYPE
     */
    static firstFulfilled<TYPE>(promises: any[]): goog_Promise<TYPE, any>;
    /**
