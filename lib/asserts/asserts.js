...
export {AssertionError, DEFAULT_ERROR_HANDLER, ENABLE_ASSERTS, assert, assertArray, assertBoolean, assertElement, assertExists, assertFinite, assertFunction, assertInstanceof, assertNumber, assertObject, assertString, fail, setErrorHandler};