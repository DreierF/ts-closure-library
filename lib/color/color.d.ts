 ...
 */
export function blend(rgb1: number[], rgb2: number[], factor: number): number[];
/**
 ...
 */
export function highContrast(prime: number[], suggestions: number[][]): number[];
/**
 * Converts from an hsl array to a hex string
 * @param {?Hsl} hsl hsl representation of the color.
 * @return {string} hex representation of the color.
 */
export function hslArrayToHex(hsl: number[]): string;
/**
 * Converts a color from HSL color space to RGB color space.
 * @param {?Hsl} hsl hsl representation of the color.
 * @return {!Rgb} rgb representation of the color.
 */
export function hslArrayToRgb(hsl: number[]): number[];
/**
 ...
 */
export function hslDistance(hsl1: number[], hsl2: number[]): number;
/**
 ...
 * @return {string} hex representation of the color.
 */
export function hsvArrayToHex(hsv: number[]): string;
/**
 * Converts an HSV triplet to an RGB array.
 * @param {?Hsv} hsv hsv representation of the color.
 * @return {!Rgb} rgb representation of the color.
 */
export function hsvArrayToRgb(hsv: number[]): number[];
/**
 ...
 * @return {!Rgb} Combined rgb color.
 */
export function lighten(rgb: number[], factor: number): number[];
/**
 ...
 * @return {!Hsl} hsl representation of the color.
 */
export function rgbArrayToHsl(rgb: number[]): number[];
/**
 * Converts from an array of RGB values to an array of HSV values.
 * @param {?Rgb} rgb rgb representation of the color.
 * @return {!Hsv} hsv representation of the color.
 */
export function rgbArrayToHsv(rgb: number[]): number[];
/**
 * Converts a color from RGB to hex representation.
