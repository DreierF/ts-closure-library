 ...
 */
fs_FileReader.readAsBinaryString = function(blob) {
 ...
 *     If an error occurs, the errback is called with a {@link FsError}.
 */
fs_FileReader.readAsArrayBuffer = function(blob) {
  var reader = new fs_FileReader();
  var d = fs_FileReader.createDeferred_(reader);
 ...
 *     If an error occurs, the errback is called with a {@link FsError}.
 */
fs_FileReader.readAsText = function(blob, opt_encoding) {
  var reader = new fs_FileReader();
  var d = fs_FileReader.createDeferred_(reader);
 ...
 *     If an error occurs, the errback is called with a {@link FsError}.
 */
fs_FileReader.readAsDataUrl = function(blob) {
  var reader = new fs_FileReader();
  var d = fs_FileReader.createDeferred_(reader);
 ...
 * @private
 */
fs_FileReader.createDeferred_ = function(reader) {
