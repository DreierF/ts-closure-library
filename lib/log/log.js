 ...
 */
function getLogRecord(logger, level, msg, exception = undefined) {
 ...
 * @param {*=} exception An exception associated with the message.
 */
function log(logger, level, msg, exception = undefined) {
 ...
 * @param {*=} exception An exception associated with the message.
 */
function error(logger, msg, exception = undefined) {
  if (ENABLED && logger) {
 ...
 * @param {*=} exception An exception associated with the message.
 */
function warning(logger, msg, exception = undefined) {
  if (ENABLED && logger) {
 ...
 * @param {*=} exception An exception associated with the message.
 */
function info(logger, msg, exception = undefined) {
  if (ENABLED && logger) {
 ...
 * @param {*=} exception An exception associated with the message.
 */
function fine(logger, msg, exception = undefined) {
  if (ENABLED && logger) {
    log(logger, Level.FINE, msg, exception);
  }
};

export {CAPACITY, ENABLED, Level, LogBuffer, LogRecordHandler, Loggable, ROOT_LOGGER_NAME, addHandler, error, fine, getAllLoggers, getEffectiveLevel, getLevel, getLogRecord, getLogger, getRootLogger, info, isLoggable, log, log_LogRecord as LogRecord, log_Logger as Logger, publishLogRecord, removeHandler, setLevel, warning};