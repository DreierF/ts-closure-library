 ...
 */
function getAllCssText(opt_styleSheet) {
 ...
 */
function getAllCssStyleRules(opt_styleSheet) {
  var styleSheet = opt_styleSheet || document.styleSheets;
  return /** @type {!Array<CSSStyleRule>} */ (
      getAllCss_(styleSheet, false));
};
 ...
 */
function getParentStyleSheet(cssRule) {
 ...
 *     the hierarchy."
 */
function addCssRule(cssStyleSheet, cssText, opt_index) {
  var index = opt_index;
 ...
 */
function removeCssRule(cssStyleSheet, index) {
  cssStyleSheet = /** @type {!CSSStyleSheet} */ (cssStyleSheet);
 ...
 */
function addCssText(cssText, opt_domHelper) {
  ...
  const nonce = safe.getStyleNonce(googdom.getWindow(document));
  if (nonce) {
 ...
 *    styleSheet.
 */
function getFileNameFromStyleSheet(styleSheet) {
...
export {CssRuleType, addCssRule, addCssText, getAllCssStyleRules, getAllCssStyleSheets, getAllCssText, getCssRuleIndexInParentStyleSheet, getCssRulesFromStyleSheet, getCssTextFromCssRule, getFileNameFromStyleSheet, getParentStyleSheet, removeCssRule, replaceCssRule};