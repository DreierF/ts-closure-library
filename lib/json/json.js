 ...
 */
function setErrorLogger(errorLogger) {
 ...
 */
let parse = USE_NATIVE_JSON ?
    /** @type {function(*):Object} */ (window['JSON']['parse']) :
    function(s) {
      let error;
      if (TRY_NATIVE_JSON) {
        try {
 ...
 */
let serialize = USE_NATIVE_JSON ?
    /** @type {function(*, ?Replacer=):string} */
...
export {Replacer, Reviver, Serializer, TRY_NATIVE_JSON, USE_NATIVE_JSON, isValid, parse, serialize, setErrorLogger};