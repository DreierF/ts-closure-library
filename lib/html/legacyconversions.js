 ...
 *     object.
 */
function safeHtmlFromString(html) {
  reportCallback_();
  return Html_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
      html, null /* dir */);
};
 ...
 *     object.
 */
function safeScriptFromString(script) {
  reportCallback_();
 ...
 *     object.
 */
function safeStyleFromString(style) {
  reportCallback_();
 ...
 */
function safeStyleSheetFromString(styleSheet) {
  reportCallback_();
 ...
 *     object.
 */
function safeUrlFromString(url) {
  reportCallback_();
 ...
 */
function trustedResourceUrlFromString(url) {
  reportCallback_();
 ...
 */
let reportCallback_ = google.nullFunction;
 ...
 */
function setReportCallback(callback) {
  reportCallback_ = callback;
};

export {safeHtmlFromString, safeScriptFromString, safeStyleFromString, safeStyleSheetFromString, safeUrlFromString, setReportCallback, trustedResourceUrlFromString};