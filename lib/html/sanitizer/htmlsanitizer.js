 ...
 * @private @const {string}
 */
let XHTML_NAMESPACE_URI_ = 'http://www.w3.org/1999/xhtml';
...
class HtmlSanitizer extends SafeDomTreeProcessor {
  ...
  createElementWithoutAttributes(dirtyElement) {
    ...
    const spanElement = goog_dom.createElement(TagName.SPAN);
...
class Builder {
  ...
  constructor() {
    ...
    googarray.forEach(
        ...
        function(wl) {
          goog_object.getKeys(wl).forEach(function(attr) {
   ...
   * @return {!Builder}
   */
  allowCustomElementTag(customElementTagName, customElementAttributes) {
