...
class SafeStyle {
  ...
  constructor(value, token) {
    ...
    this.privateDoNotAccessOrElseSafeStyleWrappedValue_ =
        (token === SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_) ? value : '';
  }
};
 ...
 * @const {boolean}
 */
SafeStyle.prototype.implementsGoogStringTypedString = true;
...
SafeStyle.unwrap = function(safeStyle) {
  ...
  if (safeStyle instanceof SafeStyle &&
    ...
    goog_asserts.fail(
        ...
        '\' of type ' + google.typeOf(safeStyle));
 ...
 * @const
 */
SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_ = {};
 ...
 * @package
 */
SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse = function(
    style) {
  return new SafeStyle(
      style, SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_);
};
  ...
  for (var name in map) {
    ...
    if (Object.prototype.hasOwnProperty.call(map, name)) {
      ...
      if (Array.isArray(value)) {
        value =
            googarray.map(value, SafeStyle.sanitizePropertyValue_)
                .join(' ');
      } else {
 ...
 * @private
 */
SafeStyle.hasBalancedSquareBrackets_ = function(value) {
  var outside = true;
