 ...
 * @template K,V
 */
export function add<K, V>(obj: any | null, key: string, val: V): void;
/**
 ...
 * @template K,V
 */
export function contains<K, V>(obj: any | null, val: V): boolean;
/**
 ...
 * @template K,V
 */
export function containsValue<K, V>(obj: any | null, val: V): boolean;
/**
 ...
 * @template T,K,V
 */
export function every<T, K, V>(obj: any | null, f: ((this: T, arg1: V, arg2: unknown, arg3: any | null) => boolean) | null, opt_obj?: T | undefined): boolean;
/**
 ...
 * @template T,K,V
 */
export function filter<T, K, V>(obj: any | null, f: (this: T, arg1: V, arg2: unknown, arg3: any | null) => boolean, opt_obj?: T | undefined): any;
/**
 ...
 * @template T,K,V
 */
export function findKey<T, K, V>(obj: any | null, f: (this: T, arg1: V, arg2: string, arg3: any | null) => boolean, thisObj?: T | undefined): string | undefined;
/**
 * Searches an object for an element that satisfies the given condition and
 * returns its value.
 * @param {?Object<K,V>} obj The object to search in.
 ...
 * @template T,K,V
 */
export function findValue<T, K, V>(obj: any | null, f: (this: T, arg1: V, arg2: string, arg3: any | null) => boolean, thisObj?: T | undefined): V;
/**
 * @license
 ...
 */
export function forEach<T = unknown, K = unknown, V = unknown>(obj: Record<K, V> | object | null, f: (this: T, arg1: V, arg2: K, arg3: any | null) => any, opt_obj?: T | undefined): void;
/**
 ...
 */
export function get<K, V, R>(obj: any | null, key: string, val?: R | undefined): V | R | undefined;
/**
 ...
 * @public
 */
export function getAllPropertyNames(obj: any | null, includeObjectPrototype?: boolean | undefined, includeFunctionPrototype?: boolean | undefined): Array<string>;
/**
 ...
 * @template K,V
 */
export function getAnyValue<K, V>(obj: any | null): V | undefined;
/**
 ...
 * @param {...(string|number|!ArrayLike<number|string>)} var_args A number of
 ...
 */
export function getValueByKeys(obj: any | null, ...args: (string | number | ArrayLike<string | number>)[]): any;
/**
 ...
 */
export function getValues<T = unknown>(obj: Record<string, T> | ArrayLike<T> | object | null): T[];
/**
 ...
 * @template T,K,V,R
 */
export function map<T, K, V, R>(obj: any | null, f: (this: T, arg1: V, arg2: unknown, arg3: any | null) => R, opt_obj?: T | undefined): any;
/**
 ...
 */
export function set<K, V>(obj: any | null, key: string, value: V): void;
/**
 ...
 * @template K,V
 */
export function setIfUndefined<K, V>(obj: any | null, key: string, value: V): V;
/**
 ...
 * @template K,V
 */
export function setWithReturnValueIfNotSet<K, V>(obj: any | null, key: string, f: () => V): V;
/**
 ...
 * @template T,K,V
 */
export function some<T, K, V>(obj: any | null, f: (this: T, arg1: V, arg2: unknown, arg3: any | null) => boolean, opt_obj?: T | undefined): boolean;
/**
